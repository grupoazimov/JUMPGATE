...
class Firewall
{
	...
	/* consts */
	private:
		static inline const std::string __group_name { "stormy/jumpgate" };
		static inline const std::string __group_name_legacy { "stormy.gg/jumpgate" };
	...
	public:
		...
		bool isNetworkProtected() const;
		int getConnectedNetworksCount() const;
